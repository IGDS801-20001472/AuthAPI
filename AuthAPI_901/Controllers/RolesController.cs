...
{
    [Authorize(Roles = "soiAdmin, Empleadozzz")]
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateRole([FromBody] CreateRolDto createRoleDto)
        {
        ...
        [HttpPost("assign")]
        public async Task<IActionResult> AssignRole([FromBody] RoleAsignDto roleAssignDto)
        {
